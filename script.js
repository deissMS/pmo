    ...
    .then(data => {
        ...
        document.getElementById('buscador').addEventListener('submit', function(e) {
            ...
            if (resultado.length > 0) {
                ...
                document.getElementById('texto-seccion').innerHTML = `<h2 class="titulo-resultado">Resultado de la búsqueda: ${resultado.length} presracione/s encontrada/s</h2>` + coberturas.join('<hr>');
            } else {
